    ...
    <div class="bg-white border-b border-gray-100 py-10">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-center gap-2 text-xs text-gray-400 mb-4">
          ...
          <span class="text-[#6CC551]">Upcoming Projects</span>
        </div>
        <p class="text-[#6CC551] text-xs font-bold uppercase tracking-widest mb-2 text-center">Coming Soon</p>
        ...
        <p class="mt-3 text-gray-500 text-sm max-w-2xl leading-relaxed text-center mx-auto">
          Projects planned and scheduled for the Ga East Municipality in the near future.
        </p>
      </div>
    </div>
    ...
    <section class="py-12 bg-gray-50 min-h-screen">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else-if="projects.length === 0"
          ...
          <p class="text-gray-500 font-medium text-sm">No upcoming projects announced yet.</p>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="relative h-48 overflow-hidden bg-gray-100">
              ...
              />
              <span class="absolute top-3 left-3 px-2.5 py-1 bg-amber-500 text-white text-xs font-bold rounded-full uppercase tracking-wide">
                Upcoming
              </span>
            </div>
...
const fetchProjects = async () => {
  ...
  try {
    const res = await axios.get(`${url}/posts`, {
      params: { category: 'UPCOMING PROJECT', page: currentPage.value, limit: perPage.value }
    });
